...
import Loading from "../Mobile/Intro";
  ...
  return (
    <div>
      ...
      <main className={`bg-[url('https://wgoqatar.com/wp-content/uploads/2021/03/windows_xp_original-wallpaper-2880x1800-1-780x470.jpg')] absolute top-0 left-0 bottom-0 right-0 z-0 bg-cover bg-no-repeat bg-center`}>
       ...
       <Menu startMenu={startMenu} setStartMenu={setStartMenu} showWindow={showWindow} setShowWindow={setShowWindow} setCurrentView={setCurrentView} resume={resume} setShowText={setShowText} showText={showText} name={resume.name} allProjects={allProjects} setAllprojects={setAllProjects} />
